...
- **Ties and movement:** students tied on adjusted score, including several at 100, are ordered by the higher raw score, then by an optional tie-breaker order stated on screen; any still tied share a rank (1, 1, 3). Rank movement compares adjusted ranks week to week.
